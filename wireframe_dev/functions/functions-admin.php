...
function wireframe_theme_admin_page_tabs_quickstart() {
	...
	<h2 class="nav-tab-wrapper wp-clearfix">
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) ); ?>" class="nav-tab nav-tab-active"><?php esc_html_e( 'Quickstart', 'wireframe-theme' ); ?></a>
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) . '-faq' ); ?>" class="nav-tab"><?php esc_html_e( 'FAQ', 'wireframe-theme' ); ?></a>
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) . '-support' ); ?>" class="nav-tab"><?php esc_html_e( 'Support', 'wireframe-theme' ); ?></a>
	</h2>
	<?php
}
...
function wireframe_theme_admin_page_tabs_faq() {
	?>
	<h2 class="nav-tab-wrapper wp-clearfix">
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) ); ?>" class="nav-tab"><?php esc_html_e( 'Quickstart', 'wireframe-theme' ); ?></a>
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) . '-faq' ); ?>" class="nav-tab nav-tab-active"><?php esc_html_e( 'FAQ', 'wireframe-theme' ); ?></a>
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) . '-support' ); ?>" class="nav-tab"><?php esc_html_e( 'Support', 'wireframe-theme' ); ?></a>
	</h2>
	<?php
}
...
function wireframe_theme_admin_page_tabs_support() {
	...
	<h2 class="nav-tab-wrapper wp-clearfix">
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) ); ?>" class="nav-tab"><?php esc_html_e( 'Quickstart', 'wireframe-theme' ); ?></a>
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) . '-faq' ); ?>" class="nav-tab"><?php esc_html_e( 'FAQ', 'wireframe-theme' ); ?></a>
		<a href="<?php echo esc_url( 'admin.php?page=' . esc_html( 'wireframe-child' ) . '-support' ); ?>" class="nav-tab nav-tab-active"><?php esc_html_e( 'Support', 'wireframe-theme' ); ?></a>
	</h2>
	<?php
}
...
function wireframe_theme_admin_page_header() {
	wireframe_theme_admin_check();
	?>
	<h1><?php echo esc_html( 'Wireframe Child' ); ?> <?php echo esc_html( WIREFRAME_THEME_VERSION ); ?></h1>
	<div class="about-text">
		<?php esc_html_e( 'Wireframe Child is the default OOP WordPress child theme boilerplate for Wireframe Theme. Wireframe Child is part of the Wireframe Suite for WordPress by MixaTheme.', 'wireframe-theme' ); ?>
	</div>
